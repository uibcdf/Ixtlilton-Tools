...
env_dict={}
env_dict["channels"]=heal(all_requirements["admin"]["channels"])
env_dict["dependencies"]=heal(all_requirements["admin"]["dependencies"])
fff = open("conda-envs/admin_env.yaml", "w")
