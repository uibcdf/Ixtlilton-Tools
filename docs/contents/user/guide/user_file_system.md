...
libraries. These three directories are included in the '$LIBRARY_PATH$' and '$LD_LIBRARY_PATH$' of your
user:
...
should be moved to the archived version of the project to be stored in the volume COLD_STORAGE_ROOM.**
